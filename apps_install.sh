...
AppFolder="./"
cacheFolderApp="/tmp/app-cache"
rm -rf $cacheFolderApp
npm_config_loglevel=silent npm i --prefix ${AppFolder} --cache $cacheFolderApp
...
dockerFolder="./"
npm_config_loglevel=silent npm run compose:up --prefix ${dockerFolder}